...
- **`core.pact`** (new, 2026-08-30): `Cognition`/`CognitionModels`/`CognitionRequirements`/
  ...
  onto a standalone [PACT](https://github.com/GiskardB/PACT/blob/main/SPECIFICATION.md) v1 Core
...
3. ✅ **PACT Core fields (ADOPT, P1)** — done, 2026-08-30. `spec.cognition`, `spec.contract`
   ...
   standalone [PACT](https://github.com/GiskardB/PACT/blob/main/SPECIFICATION.md) v1 Core document by
