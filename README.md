...
> JitPack uses the groupId `com.github.giskardb.gargantua` and versions match Git tags (e.g. `v1.2.5`).
>
...
```xml
<properties>
    <gargantua.version>v1.2.5</gargantua.version>
</properties>
