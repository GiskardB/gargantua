...
import io.agentkit.core.guardrail.GuardrailPipelineResult;
import io.agentkit.core.llm.LlmRoutingContext;
...
import io.agentkit.core.orchestrator.EnricherContext;
import io.agentkit.core.orchestrator.OrchestratorEngine;
import io.agentkit.core.orchestrator.RoutingMethod;
    ...
    public AgentResponse invoke(AgentRequest request) {
        ...
        if (skillRegistry != null) {
            ...
            SkillMeta meta = new SkillMeta(routingResult.skillName(), "", "1.0.0",
                    true, false, "general", io.agentkit.core.skill.SkillSource.FILESYSTEM);
